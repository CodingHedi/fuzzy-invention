    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="bonAppHediApp.department.home.createOrEditLabel">Create or edit a Department</h2>
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div v-if="$v.department.departmentName.$anyDirty && $v.department.departmentName.$invalid">
                            <small class="form-text text-danger" v-if="!$v.department.departmentName.required">
